...
class AirCargoProblem(Problem):
            ...
            for cargo in self.cargos:
                for plane in self.planes:
                    for airport in self.airports:
                        ...
                        unload_action = Action(expr('Unload({}, {}, {})').format(cargo, plane, airport)),[precond_pos, precond_neg], [effect_add, effect_rem]
                        unloads.apend(unload_action)
            return unloads
    ...
    def actions(self, state: str) -> list:
        ...
        for action in self.actions_list:
            ...
            if meet_precond_neg and meet_precond_pos:
    ...
    @lru_cache(maxsize=8192) # Why the maxsize of cache is 8192
